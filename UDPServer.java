    ...
    public static void main(String[] args) {
        ...
        try (
            ...
            while(true) {
                ...
                /* packet to hold the incoming data, stored in in_buf */
                ...
                /* buffer with the response message (same as received message) */
                var out_buf = in_msg.getBytes();

                /* response packet, with destination the same as the original sender */
